...
capture = cv2.VideoCapture(r'E:\vscodeProject\basketballZooming\video\3月25日.mp4')
...
if __name__ == '__main__':
    model_path = r'Classic_model_examples/2021_Yolov5_CountAndTrack/weights/yolov5s.pt'
    pred_path = r'E:\vscodeProject\basketballZooming\video\3月25日.mp4'
